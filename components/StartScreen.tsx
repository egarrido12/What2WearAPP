  ...
  const handleFileSelect = useCallback(async (file: File) => {
    ...
    reader.onload = async (e) => {
        ...
        try {
            ...
            setError(getFriendlyErrorMessage(err, 'Error al crear el modelo'));
          ...
          <div className="lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left">
            <div className="max-w-lg">
              ...
              <p className="mt-4 text-lg text-gray-600">
                ¿Cansado/a de preguntarte 'qué me pongo'? Sube tu armario y deja que tu estilista de IA cree el look perfecto para cualquier ocasión, visualizado en tu propio modelo personal.
              </p>
              ...
              <div className="flex flex-col items-center lg:items-start w-full gap-3">
                <label htmlFor="image-upload-start" className="w-full relative flex items-center justify-center px-8 py-3 text-base font-semibold text-white bg-gray-900 rounded-md cursor-pointer group hover:bg-gray-700 transition-colors">
                  ...
                  Sube una Foto para Crear tu Modelo
                </label>
                ...
                <p className="text-gray-500 text-sm">Empieza con una foto nítida de tu cara. ¡Las fotos de cuerpo entero también funcionan genial!</p>
                <p className="text-gray-500 text-xs mt-1">Al subir una imagen, aceptas no crear contenido dañino, explícito o ilegal. Este servicio es solo para uso creativo y responsable.</p>
          ...
          <div className="md:w-1/2 flex-shrink-0 flex flex-col items-center md:items-start">
            <div className="text-center md:text-left">
              ...
              <p className="mt-2 text-md text-gray-600">
                Arrastra el deslizador para ver la transformación. ¿Te gusta? Empecemos a crear estilos.
              </p>
            </div>
            ...
            {error && 
              <div className="text-center md:text-left text-red-600 max-w-md mt-6">
                ...
                <button onClick={reset} className="text-sm font-semibold text-gray-700 hover:underline">Intentar de nuevo</button>
              </div>
            }
